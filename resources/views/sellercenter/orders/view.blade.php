                ...
                <div class="shadow bg-white p-3">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4 class="text-primary">
                                ...
                                <a href="{{ url('sellercenter/orders/') }}" class="btn btn-danger btn-sm float-end mx-1 text-white">Back</a>
                                <a href="{{ url('sellercenter/invoice/'.$order->id.'/generate') }}" class="btn btn-primary btn-sm float-end mx-1 text-white">
                                    Download Invoice
                                </a>
                    ...
                    <div class="card border mt-3">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-5">
                                    <form action="{{ url('sellercenter/orders/'.$order->id) }}" method="POST">
                                        @csrf
                                        @method('PUT')
