                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <textarea type="text" name="meta_keyword" name="website_name" value="{{ $setting->meta_keyword ?? ''  }}" class="form-control" rows="3">
                            </textarea>
                        </div>

                        <div class="col-md-6 mb-3">
                            <label>Meta Description</label>
                            <textarea type="text" name="meta_description" name="website_name" value="{{ $setting->meta_description ?? ''  }}" class="form-control" rows="3">
                            </textarea>
                        </div>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-mb-6 mb-3">
                            <label>phone 1 *</label>
                            <input type="text" name="phone1" value="{{ $setting->phone1 ?? ''  }}" class="form-control"></input>
                        </div>

                        <div class="col-mb-6 mb-3">
                            <label>phone 2 *</label>
                            <input type="text" name="phone2" value="{{ $setting->phone2 ?? ''  }}" class="form-control"></input>
                        </div>

                        <div class="col-mb-6 mb-3">
                            <label>Email Id 1 *</label>
                            <input type="text" name="email1" value="{{ $setting->email1 ?? ''  }}" class="form-control"></input>
                        </div>

                        <div class="col-mb-6 mb-3">
                            <label>email Id 2 *</label>
                            <input type="text" name="email2" value="{{ $setting->email2 ?? ''  }}" class="form-control"></input>
                        </div>
